        ...
        <div class="row">
            <div class="col-md-4 col-lg-4 col-xl-4">
                <aside class="widget about_widget">
                    ...
                    <p>
                        Beauty parlours often employ licensed professionals such as hairstylists, estheticians, nail technicians, and massage therapists.  
                    </p>
            ...
            <div class="col-md-4 col-lg-4 col-xl-3 offset-xl-1">
                <aside class="widget">
                    ...
                    <div class="info_box">
                        ...
                        <p>Bhairopatti Darbhamga Dr A.PJ.Abdul<br> kalam chowk 846009</p>
                    </div>
                    <div class="info_box">
                        <i class="icofont-phone"></i>
                        <p>Helpline 24/7<br> 6203215646</p>
                    </div>
                    <div class="info_box">
